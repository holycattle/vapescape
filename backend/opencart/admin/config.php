...
// DIR
define('DIR_APPLICATION', '/root/vapescape/admin/');
define('DIR_SYSTEM', '/root/vapescape/system/');
define('DIR_LANGUAGE', '/root/vapescape/admin/language/');
define('DIR_TEMPLATE', '/root/vapescape/admin/view/template/');
...
define('DIR_CATALOG', '/root/vapescape/catalog/');
